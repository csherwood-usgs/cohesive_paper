...
flist = {'verneyc14_0025','verneyc14_005','verneyc14_093','verneyc14_02','verneyc14_04','verneyc14_08',...
    'verneyc14_16','verneyc14_32'};
...
set(gca,'XLim',[0,1060])
hle=legend([h1],'C_0=0.025','C_0=0.05','C_0=0.093','C_0=0.2','C_0=0.4','C_0=0.8',...
    'C_0=1.6','C_0=3.2',...
       'Location','BestOutside');
set(gca,'Position',aa)
eval(['print -dpng multiC_verney_G_D.png'])
%%
figure(56);clf
set(gcf,'PaperPosition',[.5,.5,10.5,8]);wysiwyg
subplot('Position',[0.1   0.675   0.72   0.225])
...
eval(['print -dpng multiC_verney_G_D_log.png'])
