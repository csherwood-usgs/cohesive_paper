...
legend('0.1 kg/m^3','0.2 kg/m^3','0.3 kg/m^3','0.5 kg/m^3','0.7 kg/m^3',...
       ...
       '10 kg/m^3','20 kg/m^3','50 kg/m^3','100 kg/m^3','Location','Best')
print -dpng Multiple_cases_steady_moreclass.png
%%
...
a3=line(G{9}, d{9},'Marker','.','MarkerSize',16,'Color',[.5,0,0],'LineStyle','none');%5       %58
a9=line(G{8}, d{8},'Marker','.','MarkerSize',16,'Color','r','LineStyle','none');%3            %72
a8=line(G{7}, d{7},'Marker','.','MarkerSize',16,'Color','c','LineStyle','none');%2            %71
a1=line(G{6}, d{6},'Marker','.','MarkerSize',16,'Color',[.8,.5,0],'LineStyle','none');%1      %56
a7=line(G{5}, d{5},'Marker','.','MarkerSize',16,'Color','k','LineStyle','none');%0.7          %70
a6=line(G{4}, d{4},'Marker','.','MarkerSize',16,'Color','b','LineStyle','none');%0.5          %69
...
print -dpng Multiple_cases_steady_moreclass_G_D.png
%%
figure(123);clf
...
a3=line(G{9}, c{9},'Marker','.','MarkerSize',16,'Color',[.5,0,0],'LineStyle','none');%5       %58
a9=line(G{8}, c{8},'Marker','.','MarkerSize',16,'Color','r','LineStyle','none');%3            %72
a8=line(G{7}, c{7},'Marker','.','MarkerSize',16,'Color','c','LineStyle','none');%2            %71
a1=line(G{6}, c{6},'Marker','.','MarkerSize',16,'Color',[.8,.5,0],'LineStyle','none');%1      %56
a7=line(G{5}, c{5},'Marker','.','MarkerSize',16,'Color','k','LineStyle','none');%0.7          %70
a6=line(G{4}, c{4},'Marker','.','MarkerSize',16,'Color','b','LineStyle','none');%0.5          %69
...
legend([a4(1),a2(1),a5(1),a6(1),a7(1),a1(1),a8(1),a9(1),a3(1),a10(1),a11(1),a12(1),a13(1),a14(1)],...
       ...
       '2 kg/m^3','3 kg/m^3','5 kg/m^3','7 kg/m^3','10 kg/m^3','20 kg/m^3','50 kg/m^3','100 kg/m^3' ,...
       'Location','BestOutside')
print -dpng Multiple_cases_steady_moreclass_G_C.png
%%
figure(124);clf
ylabel('Average Diameter D (\mum)','FontSize',14)
...
a3=line(c{9}, d{9},'Marker','.','MarkerSize',16,'Color',[.5,0,0],'LineStyle','none');%5       %58
a9=line(c{8}, d{8},'Marker','.','MarkerSize',16,'Color','r','LineStyle','none');%3            %72
a8=line(c{7}, d{7},'Marker','.','MarkerSize',16,'Color','c','LineStyle','none');%2            %71
a1=line(c{6}, d{6},'Marker','.','MarkerSize',16,'Color',[.8,.5,0],'LineStyle','none');%1      %56
a7=line(c{5}, d{5},'Marker','.','MarkerSize',16,'Color','k','LineStyle','none');%0.7          %70
a6=line(c{4}, d{4},'Marker','.','MarkerSize',16,'Color','b','LineStyle','none');%0.5          %69
...
legend([a4(1),a2(1),a5(1),a6(1),a7(1),a1(1),a8(1),a9(1),a3(1),a10(1),a11(1),a12(1),a13(1),a14(1)],...
       ...
       '2 kg/m^3','3 kg/m^3','5 kg/m^3','7 kg/m^3','10 kg/m^3','20 kg/m^3','50 kg/m^3','100 kg/m^3' ,...
       'Location','BestOutside')
print -dpng Multiple_cases_steady_moreclass_C_D.png
%%
figure(1244);clf
ylabel('Average Diameter D (\mum)','FontSize',14)
xlabel('Average Concentration (kg m^{-3})','FontSize',14)
...
legend([a4(1),a2(1),a5(1),a6(1),a7(1),a1(1),a8(1),a9(1),a3(1),a10(1),a11(1),a12(1),a13(1),a14(1)],...
       ...
       '2 kg/m^3','3 kg/m^3','5 kg/m^3','7 kg/m^3','10 kg/m^3','20 kg/m^3','50 kg/m^3','100 kg/m^3' ,...
       'Location','BestOutside')
print -dpng Multiple_cases_steady_moreclass_C_D_log.png
%%
figure(125);clf
...
a3=line(c{9}, wsa{9},'Marker','.','MarkerSize',16,'Color',[.5,0,0],'LineStyle','none');%5       %58
a9=line(c{8}, wsa{8},'Marker','.','MarkerSize',16,'Color','r','LineStyle','none');%3            %72
a8=line(c{7}, wsa{7},'Marker','.','MarkerSize',16,'Color','c','LineStyle','none');%2            %71
a1=line(c{6}, wsa{6},'Marker','.','MarkerSize',16,'Color',[.8,.5,0],'LineStyle','none');%1      %56
a7=line(c{5}, wsa{5},'Marker','.','MarkerSize',16,'Color','k','LineStyle','none');%0.7          %70
a6=line(c{4}, wsa{4},'Marker','.','MarkerSize',16,'Color','b','LineStyle','none');%0.5          %69
...
legend([a4(1),a2(1),a5(1),a6(1),a7(1),a1(1),a8(1),a9(1),a3(1),a10(1),a11(1),a12(1),a13(1),a14(1)],...
       ...
       '2 kg/m^3','3 kg/m^3','5 kg/m^3','7 kg/m^3','10 kg/m^3','20 kg/m^3','50 kg/m^3','100 kg/m^3' ,...
       'Location','BestOutside')
print -dpng Multiple_cases_steady_moreclass_C_WS.png
%%
figure(1255);clf
ylabel('settling velocity (mm s^{-1})','FontSize',14)
xlabel('Average Concentration (kg m^{-3})','FontSize',14)
...
legend([a4(1),a2(1),a5(1),a6(1),a7(1),a1(1),a8(1),a9(1),a3(1),a10(1),a11(1),a12(1),a13(1),a14(1)],...
       ...
       '2 kg/m^3','3 kg/m^3','5 kg/m^3','7 kg/m^3','10 kg/m^3','20 kg/m^3','50 kg/m^3','100 kg/m^3' ,...
       'Location','BestOutside')
print -dpng Multiple_cases_steady_moreclass_C_WS_log.png
%%
figure(126);clf
ylabel('settling velocity (mm s^{-1})','FontSize',14)
...
a3=line(d{9}, wsa{9},'Marker','.','MarkerSize',16,'Color',[.5,0,0],'LineStyle','none');%5       %58
a9=line(d{8}, wsa{8},'Marker','.','MarkerSize',16,'Color','r','LineStyle','none');%3            %72
a8=line(d{7}, wsa{7},'Marker','.','MarkerSize',16,'Color','c','LineStyle','none');%2            %71
a1=line(d{6}, wsa{6},'Marker','.','MarkerSize',16,'Color',[.8,.5,0],'LineStyle','none');%1      %56
a7=line(d{5}, wsa{5},'Marker','.','MarkerSize',16,'Color','k','LineStyle','none');%0.7          %70
a6=line(d{4}, wsa{4},'Marker','.','MarkerSize',16,'Color','b','LineStyle','none');%0.5          %69
a5=line(d{3}, wsa{3},'Marker','.','MarkerSize',16,'Color','g','LineStyle','none');%0.3          %68
a2=line(d{2}, wsa{2},'Marker','.','MarkerSize',16,'Color',[.3,.3,.3],'LineStyle','none');%0.2   %57
a4=line(d{1}, wsa{1},'Marker','.','MarkerSize',16,'Color',[.6,.6,.6],'LineStyle','none');%0.1   %67
%axis([0, 10,0,6])
legend([a4(1),a2(1),a5(1),a6(1),a7(1),a1(1),a8(1),a9(1),a3(1),a10(1),a11(1),a12(1),a13(1),a14(1)],...
       '0.1 kg/m^3','0.2 kg/m^3','0.3 kg/m^3','0.5 kg/m^3','0.7 kg/m^3','1 kg/m^3',...
       '2 kg/m^3','3 kg/m^3','5 kg/m^3','7 kg/m^3','10 kg/m^3','20 kg/m^3','50 kg/m^3','100 kg/m^3' ,...
       'Location','BestOutside')
print -dpng Multiple_cases_steady_moreclass_D_WS.png
%%
figure(127);clf
ylabel('settling velocity (mm s^{-1})','FontSize',14)
xlabel('Turbulence Shear Rate G (s^{-1})','FontSize',14)
...
a3=line(G{9}, wsa{9},'Marker','.','MarkerSize',16,'Color',[.5,0,0],'LineStyle','none');%5       %58
a9=line(G{8}, wsa{8},'Marker','.','MarkerSize',16,'Color','r','LineStyle','none');%3            %72
a8=line(G{7}, wsa{7},'Marker','.','MarkerSize',16,'Color','c','LineStyle','none');%2            %71
a1=line(G{6}, wsa{6},'Marker','.','MarkerSize',16,'Color',[.8,.5,0],'LineStyle','none');%1      %56
a7=line(G{5}, wsa{5},'Marker','.','MarkerSize',16,'Color','k','LineStyle','none');%0.7          %70
a6=line(G{4}, wsa{4},'Marker','.','MarkerSize',16,'Color','b','LineStyle','none');%0.5          %69
...
legend([a4(1),a2(1),a5(1),a6(1),a7(1),a1(1),a8(1),a9(1),a3(1),a10(1),a11(1),a12(1),a13(1),a14(1)],...
       ...
       '2 kg/m^3','3 kg/m^3','5 kg/m^3','7 kg/m^3','10 kg/m^3','20 kg/m^3','50 kg/m^3','100 kg/m^3' ,...
       'Location','BestOutside')
print -dpng Multiple_cases_steady_moreclass_G_WS.png
...
print -dpng Winterwerp_Multiple_cases_steady_moreclass.png
%%
figure(23);clf
%plot(tconc_mn/Gc_mn**q,(1e-3*fdiam_av_mn)**(2*q),'.')
%plot( c[0]/G[0]**q, (1e-3*d[0])**(2.*q),'.',label="1 kg/m^3")
...
legend('5 kg/m^3','1 kg/m^3','0.2 kg/m^3','1 kg/m^3 nf=1.9','1 kg/m^3 nf=2.1',...
       '1 kg/m^3 N=20','1 kg/m^3 N=100' ,0)
print -dpng Winterwerp_Multiple_cases_allo_steady_moreclass.png
%%
figure(133);clf
%plot(tconc_mn/Gc_mn**q,(1e-3*fdiam_av_mn)**(2*q),'.')
%plot( c[0]/G[0]**q, (1e-3*d[0])**(2.*q),'.',label="1 kg/m^3")
...
legend([a1(1),a2(1),a3(1),a4(1),a5(1),a6(1),a7(1)],...
    '5 kg/m^3','1 kg/m^3','0.2 kg/m^3','1 kg/m^3 nf=1.9','1 kg/m^3 nf=2.1',...
       '1 kg/m^3 N=20','1 kg/m^3 N=100' ,0)
print -dpng Winterwerp_Multiple_cases_all_steady_moreclass.png
%%
figure(131);clf
%plot(tconc_mn/Gc_mn**q,(1e-3*fdiam_av_mn)**(2*q),'.')
%plot( c[0]/G[0]**q, (1e-3*d[0])**(2.*q),'.',label="1 kg/m^3")
...
legend([a1(1),a2(1),a3(1),a6(1),a7(1)],...
    '5 kg/m^3','1 kg/m^3','0.2 kg/m^3',...
       '1 kg/m^3 N=20','1 kg/m^3 N=100' ,0)
print -dpng Winterwerp_Multiple_cases_all_nf2_steady_moreclass.png
%%
figure(14);clf
...
legend('5 kg/m^3','1 kg/m^3','0.2 kg/m^3','1 kg/m^3 nf=1.9','1 kg/m^3 nf=2.1',...
       '1 kg/m^3 N=20','1 kg/m^3 N=100' ,0)
print -dpng Multiple_cases_diam_WS_steady_moreclass.png
%%
figure(15);clf
...
legend([a1(1),a2(1),a3(1),a4(1),a5(1),a6(1),a7(1),a8(1),a9(1),a10(1),a11(1)],...
    ...
    0);
print -dpng Multiple_cases_diam_WS_all_steady_moreclass.png
%%
figure(16);clf
set(gcf,'PaperPosition',[.5,.5,10,10]);wysiwyg
xlabel('Average concentration ','FontSize',14)
...
legend([a2(1),a4(1),a5(1),a6(1),a7(1),a8(1),a9(1),a10(1),a11(1)],...
    '1 kg/m^3','1 kg/m^3 nf=1.9','1 kg/m^3 nf=2.1',...
       '1 kg/m^3 N=20','1 kg/m^3 N=100','1 kg/m^3 cl_o=1','1 kg/m^3 cl_o=5','1 kg/m^3 NCS=7','1 kg/m^3 NCS=22',...
    0);
print -dpng Multiple_cases_diam_WS_1kg_steady_moreclass.png
%%
figure(17);clf
set(gcf,'PaperPosition',[.5,.5,10,10]);wysiwyg
xlabel('Average concentration ','FontSize',14)
...
legend([a12(1),a2(1),a13(1),a14(1),a15(1),a1(1),a16(1),a17(1),a3(1),a18(1),a19(1),a20(1),a21(1),a22(1)],...
    ...
    'Location','BestOutside');
print -dpng Multiple_cases_diam_WS_diffConc_steady_moreclass.png
